...
public class SiteManagerInfo extends CenterConfigElement
{
	...
	{
		String managerState = this
		        .getProperty(SiteManagerInfo.KEY_MANAGER_STATE);
	...
	public SiteManagerInfo setDispatched(boolean dispatched, boolean refreshNow)
	...
	public SiteManagerInfo setSiteToHandle(String siteToHandle,
	        boolean refreshNow) throws InterruptedException, IOException,
	        KeeperException
	{
